  ...
  6'b000000:                                    
        case(func)                                  // R-type
          ...
          `ADDU: controls <= 10'b 1_01_00_00_0_x_0; // ADDU
           ...
           `NOR,                                    // NOR
           `SLT,                                    // SLT
          `SLTU: controls <= 10'b 1_01_00_00_0_0_0; // SLTU
           `SLL: controls <= 10'b 1_01_00_01_0_0_0; // SLL
          `SLLV: controls <= 10'b 1_01_00_00_0_0_0; // SLLV
           `SRL: controls <= 10'b 1_01_00_01_0_0_0; // SRL
          `SRLV: controls <= 10'b 1_01_00_00_0_0_0; // SRLV
           `SRA: controls <= 10'b 1_01_00_01_0_0_0; // SRA
          `SRAV: controls <= 10'b 1_01_00_00_0_0_0; // SRAV
            `JR: controls <= 10'b 0_xx_xx_xx_x_x_0; // JR
          `JALR: controls <= 10'b 1_00_00_xx_x_x0; // JALR
